<template>
  <div id="trash" class="detail">
    ...
    <div class="note-detail">
      ...
      <div class="editor">
        <div class="preview markdown-body" v-html="compiledMarkdown">
  ...
  data() {
    return {
      ...
      curTrashNote: {
        ...
        title: '我的笔记',
        content: '## hello',
        createdAtFriendly: '2 day ago',
        updatedAtFriendly: '3just moment'
      },
      belongTo: '我的笔记本',
      trashNotes: [
        {
          ...
          title: '我的笔记',
          content: '## hello',
          createdAtFriendly: '4 day ago',
          updatedAtFriendly: '5just moment'
        },
        {
          id: 4,
          title: '我的笔记',
          content: '## hello',
          createdAtFriendly: '1 day ago',
